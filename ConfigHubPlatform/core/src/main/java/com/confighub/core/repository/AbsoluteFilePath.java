...
@NamedQueries(
      {
            @NamedQuery( name = "AbsFilePath.getByAbsPath",
                         query = "SELECT k FROM AbsoluteFilePath k WHERE k.repository=:repository AND k.absPath=:absPath" ),
            @NamedQuery( name = "AbsFilePath.searchByAbsPath",
                         query = "SELECT k FROM AbsoluteFilePath k WHERE k.repository=:repository AND k.absPath LIKE :absPath" ),
            @NamedQuery( name = "AbsFilePath.searchByPath",
                         query = "SELECT k FROM AbsoluteFilePath k WHERE k.repository=:repository AND k.path LIKE :path" )
      } )
@Audited
