...
@NamedQueries(
      {
            @NamedQuery( name = "Level.getByName",
                         query = "SELECT l FROM CtxLevel l WHERE l.repository=:repository AND UPPER(l.name)=:name AND l.depth=:depth" ),

            @NamedQuery( name = "Level.getForDepth",
                         query = "SELECT l FROM CtxLevel l WHERE l.repository=:repository AND l.depth=:depth" ),

            @NamedQuery( name = "Level.depthCount",
                         query = "SELECT COUNT(l) FROM CtxLevel l WHERE l.repository=:repository AND l.depth=:depth" ),
      } )
