...
@NamedQueries(
      {
            @NamedQuery( name = "RevisionEntry.get",
                         query = "SELECT r FROM RevisionEntry r WHERE r.repositoryId=:repositoryId AND r.id=:id" ),

            @NamedQuery( name = "Repository.first",
                         query = "SELECT r FROM RevisionEntry r WHERE r.repositoryId=:repositoryId " +
                                 "AND r.commitGroup IN :commitGroupList " +
                                 "ORDER BY r.id DESC" ),
            ...
            @NamedQuery( name = "Notifications.first",
                         query = "SELECT r FROM RevisionEntry r WHERE r.repositoryId=:repositoryId AND r.notify=true " +
                                 "ORDER BY r.id DESC" ),
